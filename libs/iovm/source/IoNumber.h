...
IOVM_API IO_METHOD(IoNumber, poundKilo);
IOVM_API IO_METHOD(IoNumber, kiloPound);
IOVM_API IO_METHOD(IoNumber, celsiusFahrenheit);
IOVM_API IO_METHOD(IoNumber, fahrenheitToCelsius);
IOVM_API IO_METHOD(IoNumber, teaspoonMilliliter);
IOVM_API IO_METHOD(IoNumber, milliliterTeaspoon);
IOVM_API IO_METHOD(IoNumber, millilitersTablespoon);
IOVM_API IO_METHOD(IoNumber, tablespoonMilliliters);
IOVM_API IO_METHOD(IoNumber, gramsOunce);
IOVM_API IO_METHOD(IoNumber, ounceGrams);
IOVM_API IO_METHOD(IoNumber, mileKilometer);
IOVM_API IO_METHOD(IoNumber, kilometerMile);
IOVM_API IO_METHOD(IoNumber, inchesCentimeter);
IOVM_API IO_METHOD(IoNumber, centimeterInches);
...
IOVM_API IO_METHOD(IoNumber, isSquare);
IOVM_API IO_METHOD(IoNumber, isTriangular);
